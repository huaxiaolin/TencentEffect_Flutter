...
import '../../uikit/manager/te_res_path_manager_android.dart';
import '../../uikit/manager/te_res_path_manager_ios.dart';




abstract class TEResPathManager {
  ...
  static TEResPathManager getResManager() {
    if (resPathManager == null) {
      if (Platform.isAndroid) {
        resPathManager = TEResPathManagerAndroid();
      } else if (Platform.isIOS) {
        resPathManager = TEResPathManagerIos();
      } else {}
  ...
  static TEResPathManager? resPathManager;

  TEResPathManager._internal();
}
